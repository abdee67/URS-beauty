...
class GetServiceByCategory {
  final ServiceRepository repository;

  GetServiceByCategory(this.repository);

  Future<Either<Failures, List<ServiceEntity>>> call(String categoryId) {
    return repository.getServiceByCategory(categoryId);
  }
}