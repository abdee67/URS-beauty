...
class PaymentSuccessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final reference =
        payment.transactionReference ?? payment.stripePaymentIntentId ?? payment.id;
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _SuccessRow(
                      label: 'Date',
                      value: localizations.formatMediumDate(booking.scheduledAt),
                    ),
                    _SuccessRow(
                      label: 'Time',
                    ...
                    _SuccessRow(label: 'Paid', value: paidLabel, highlight: true),
