...
ALTER FUNCTION "public"."handle_new_customer_signup"() OWNER TO "postgres";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."stylists_availability";
...
GRANT ALL ON FUNCTION "public"."handle_new_customer_signup"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_new_customer_signup"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_new_customer_signup"() TO "service_role";
